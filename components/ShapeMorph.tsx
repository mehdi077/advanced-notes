    ...
    >
      <div className="relative flex items-center justify-center h-[400px] w-[400px]">
        ...
        <motion.div
          ...
          className={`absolute w-64 h-64 rounded-full ${config.glowColor} blur-[100px]`}
        />
        ...
        {[...Array(3)].map((_, i) => (
          <motion.div
            ...
            className="absolute rounded-full border border-zinc-700 border-opacity-10"
            style={{
              width: 240 + i * 40,
              height: 240 + i * 40,
        ...
        <motion.div
          ...
          className="relative z-10 w-32 h-32 rounded-full cursor-pointer flex items-center justify-center shadow-2xl overflow-hidden"
          style={{
